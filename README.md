...
如果使用电脑端游玩，建议把浏览器窗口缩小到接近下图这个尺寸，约 `611 x 944 px`。这样画面、棋盘和按钮的显示会更接近手机竖屏设计效果。

![电脑端推荐窗口大小](docs/assets/desktop-window-reference.png)
...
- 网页试玩版会默认使用接近手机竖屏的外框，普通电脑浏览器打开也会尽量保持这个比例。
- 如果你在电脑上试玩时觉得画面比例不对，请把浏览器窗口缩小到 README 上方参考图的程度，约 `611 x 944 px`，然后强制刷新页面。
