...
namespace WheatTown.EditorTools
{
    public static class WheatTownUiPreviewBuilder
    {
        ...
        private static void CreateTaskPreview(Transform root, Vector2 offset)
        {
            ...
            Header(page, "任务顶部栏_TaskHeader", new Vector2(0, 292), new Vector2(386, 60), "Tasks     Orders     Album     Route");
            ...
            Text(page, "任务说明_OrderHint", "Orders give coins and materials. Album is a top tab.", new Vector2(0, -88), new Vector2(304, 56), 16, new Color(.27f, .25f, .20f, 1f), TextAlignmentOptions.Center);
        ...
        {
            // Mirrors the runtime parchment-safe agreement width so preview edits transfer 1:1.
            Slot(page, name, pos, new Vector2(292, 38), "□  " + label);
        }
